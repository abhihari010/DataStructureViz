      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto">
            Learn DSA concepts with real-time visualizations, synchronized code
            examples, and hands-on practice problems. Perfect for students and
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Our platform combines visual learning with practical coding to
              give you the complete understanding you need.
            </p>
          </div>
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              From basic data structures to advanced algorithms, we cover
              everything you need for academic success and interview
              preparation.
            </p>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-12 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-gray-400 mb-6">
            Making data structures and algorithms accessible through interactive
            visualization.
          </p>

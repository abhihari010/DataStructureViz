...
export default function Home() {
  ...
  const recentTopics = [
    ...
    { id: "linked-list", name: "Linked List", status: "in-progress", difficulty: "Beginner" },
    { id: "binary-tree", name: "Binary Tree", status: "not-started", difficulty: "Intermediate" },
  ];

  const recommendations = [
    { id: "stack", name: "Stack Data Structure", type: "Data Structure", time: "15 min" },
    { id: "bubble-sort", name: "Bubble Sort", type: "Algorithm", time: "20 min" },
    { id: "binary-search", name: "Binary Search", type: "Algorithm", time: "25 min" },
  ];
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600">
                Continue your DSA journey and track your progress toward mastery.
              </p>
            </div>
                        ...
                        <div key={topic.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                          <div className="flex items-center space-x-3">
                            <div className={`w-3 h-3 rounded-full ${
                              ...
                              topic.status === 'in-progress' ? 'bg-yellow-500' : 'bg-gray-300'
                            }`} />
                            <div>
                ...
                <Card className="h-full">
                  ...
                  <CardContent className="space-y-4">
                    {recommendations.map((item) => (
                      <div key={item.id} className="p-3 border rounded-lg hover:bg-gray-50 transition-colors cursor-pointer">
                        <div className="flex items-center justify-between mb-2">
